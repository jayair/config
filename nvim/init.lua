...
-- NOTE: Using vim-tmux-navigator instead
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        -- NOTE: Uses flag set by FormatDisable and FormatEnable
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        -- Don't auto-select first option "noselect"
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'dockerfile' },
